...
class Encoder(nn.Module):
    ...
    def forward(self, x, tau):
        ...
        z = torch.stack(tokens, dim=1)  # [B, ≤max_seq_len, vocab_size]
        return z, lengths
...
class Decoder(nn.Module):
    ...
    def forward(self, z, lengths):
        ...
        z_emb = self.embedding(z)  # [B, L, emb]
...
decoder = Decoder(vocab_size, embedding_dim, hidden_dim, input_dim).to(device)
